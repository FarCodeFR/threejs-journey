...
window.addEventListener("click", () => {
  if (currentIntersect) {
    switch (currentIntersect.object) {
      case object1:
        console.log("Click objet 1");
        break;
      case object2:
        console.log("Click objet 2");
        break;
      case object3:
        console.log("Click objet 3");
        break;
    }
  }
});
...
let model = null;
gltfLoader.load("./models/Duck/glTF-Binary/Duck.glb", (glft) => {
  model = glft.scene;
